...
<table border="1"> <!-- membuat kolom tabel -->
	...
	<?php  
	include 'konekdb.php'; //koneksi dengan file konek database
	$data_peserta = mysqli_query($koneksi, "SELECT *from data_peserta");//query untuk mengakses tabel pendaftaran di database
	$no=1;
	foreach ($data_peserta as $row) { //perulangan untuk memmbaca nilai Array
		echo "<tr> 
			<td>$no</td>
...
<br>
<form method="POST" action="dataexcel.php">
